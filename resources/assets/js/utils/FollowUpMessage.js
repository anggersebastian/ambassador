...
const codMessage = (arg) => {
    ...
    return `Hai kak *${arg.name}*, Perkenalkan saya Ridwan CS Dropy.id😊Pesanan Anda sudah kami Terima, Berikut rinciannya: %0a%0a*Produk*:${arg.product} %0a${address}*Harga Produk*: Rp ${arg.product_price} %0a${ongkir}*Total Pembayaran*: Rp ${arg.total}  %0a%0aPembayaran dilakukan setelah Barang Sampai (COD), Mohon siapkan pembayaran sejumlah *Rp ${arg.total}*`
}
